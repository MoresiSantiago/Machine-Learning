...
@app.get('/desarrollador/ {item_id}')  # Cantidad de items y porcentajede contenido Free por año según empresa desarrolladora
...
@app.get('/userdata/ {user_id}') # Debe devolver cantidadde dinero gastado por el usuario, el porcentajede recomendación en base a reviews.recommend y cantidad de items
